...
//   // Sum of quantities (not row count) — two units of the same product
//   // in the cart should read as "2" on the badge, not "1". Only queried
//   // when a customer is actually logged in; the badge is meaningless
//   // otherwise, so this stays 0 rather than issuing a wasted query.
//   let cartCount = 0;
//   if (customerSession) {

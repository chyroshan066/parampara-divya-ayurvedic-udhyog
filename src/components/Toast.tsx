...
export function Toast({ type, message, onClose, duration = 6000 }: ToastProps) {
  useEffect(() => {
  ...
  return (
    <div
      role="alert"
      className={`tw:fixed tw:bottom-6 tw:left-6 tw:z-[9999] tw:flex tw:items-start tw:gap-x-3 tw:max-w-sm tw:w-[calc(100%-3rem)] tw:sm:w-96 tw:rounded-2xl tw:shadow-lg tw:px-4 tw:py-3 tw:border ${
        isSuccess

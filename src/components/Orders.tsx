...
//             {orders.length === 0 ? (
//               <div className="ayur-order-empty">
//                 <span className="ayur-order-empty-icon">
//                   <svg
//                     width="56"
//                     height="56"
//                     viewBox="0 0 24 24"
...
//                   </svg>
//                 </span>
//                 <h3 className="ayur-order-empty-title">No Orders Yet</h3>
//                 <p className="ayur-order-empty-text">
//                   Looks like you haven&apos;t placed any orders. Once you do,
//                   they&apos;ll show up here so you can track and manage them.
//                 </p>
//                 <Link href="/shop" className="ayur-btn ayur-order-empty-btn">
//                   Start Shopping
//                 </Link>
//               </div>
//             ) : (

  ...
  return (
    <div>
      ...
      {products.length === 0 ? (
        ...
        <div className="tw:grid tw:grid-cols-1 tw:sm:grid-cols-2 tw:lg:grid-cols-3 tw:gap-5">
          {products.map((product) => (
            ...
            >
              <div className="tw:aspect-square tw:bg-gray-50">
                {product.image_url && (
                  <img
      ...
      {isModalOpen && (
        ...
        >
          <div
            className="tw:bg-white tw:rounded-3xl tw:w-full tw:max-w-md tw:max-h-[90vh] tw:overflow-y-auto tw:p-6"
          ...
          >
            <div className="tw:flex tw:items-center tw:justify-between tw:mb-6">
              ...
              <button
                type="button"
                onClick={closeModal}
                className="tw:text-slate-400 tw:hover:text-slate-600"
                aria-label="Close"
              >
            ...
            <form onSubmit={handleSubmit} className="tw:flex tw:flex-col tw:gap-y-4">
              <div>
                ...
                <input
                  ...
                  className="tw:w-full tw:border tw:border-gray-200 tw:rounded-xl tw:px-4 tw:py-2.5 tw:text-sm"
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="tw:w-full tw:border tw:border-gray-200 tw:rounded-xl tw:px-4 tw:py-2.5 tw:text-sm tw:resize-none"
